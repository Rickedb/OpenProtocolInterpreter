...
namespace OpenProtocolInterpreter.Tool
{
    ...
    public class MID_0041 : MID, ITool
    {
        ...
        public MID_0041(string toolSerialNumber, long toolNumberOfTightenings,  DateTime lastCalibrationDate, 
        ...
        public class OpenEndDataConverter : IValueConverter<OpenEndDatas>
        {
