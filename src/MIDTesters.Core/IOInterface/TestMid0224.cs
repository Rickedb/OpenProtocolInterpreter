...
namespace MIDTesters.IOInterface
{
    ...
    public class TestMid0224 : DefaultMidTests<Mid0224>
    {
        ...
        public void Mid0224Revision1()
        {
            ...
            Assert.AreEqual(DigitalInputNumber.ClickWrench4, mid.DigitalInputNumber);
        ...
        public void Mid0224PackRevision1()
        {
            string package = "00230224            065";

            AssertBuildAndParse(package, new Mid0224()
            {
                DigitalInputNumber = DigitalInputNumber.ClickWrench4
            }, true);
        }
    }
}
